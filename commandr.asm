...
ChgDisk1        db 'ÚÄÄÄÄÄÄÄÄ¿'
ChgDisk2        db '³      ³'
ChgDisk3        db 'ÀÄÄÄÄÄÄÄÄÙ'
DiskInfo        db 27 dup('$')
...
Poscountright   db -1
NumDisk         dw 0
Ramka           db 2 dup ('ÉÍÍÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍ»')
                db 2 dup ('º    Name    ³    Name    ³    Name    º')
                db 34 dup ('º            ³            ³            º')
                db 2 dup ('ÇÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄ¶')
                db 4 dup ('º                                      º')
                db 2 dup ('ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼')
                db 160 dup (' ')
...
pan_st  db      'ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ ®¨áª ä ©«  ÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»',0
        db      'º                                                                          º',0
        db      'º                                                                          º',0
        db      'º                                                                          º',0
        db      'º                                                                          º',0
        ...
        db      'º                                                                          º',0
        db      'º                                                                          º',0
        db      'ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶',0
        db      'º  ©â¨ ä ©«(ë) [úúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúú] º',0
        db      'º Š â «®£:                                                                 º',0
        db      'º ‘®¤¥à¦ é¨¥    [úúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúúú]                        º',0
        db      'ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶',0
        db      'º  Ú Œ¥áâ® ¯®¨áª  ÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿   Ú Ž¯æ¨¨ ¯®¨áª  ÄÄÄÄÄÄÄÄ¿               º',0
        db      'º  ³ ( ) ‚¥áì ¤¨áª              ³   ³ [ ] ®¨áª ¯®¢â®à®¢   ³               º',0
        db      'º  ³ ( ) Š â «®£(¨) ¨ ­¨¦¥      ³   ³ [ ] ’®«ìª® â¥ªáâ     ³               º',0
        db      'º  ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ               º',0
        db      'º                                                                          º',0
        db      'ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶',0
        db      'º       Câ àâ  Ü   „¨áª  Ü   F10-„¥à¥¢®  Ü    áè¨p¥­­ë©  Ü   ‚ëå®¤  Ü     º',0
        db      'º      ßßßßßßßßß  ßßßßßßßß  ßßßßßßßßßßßßßß  ßßßßßßßßßßßßßßß  ßßßßßßßßß     º',0
        db      'ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼',0
@write   db      'ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»',0
         db      'º ÛÛÛ»   ÛÛ»  ÛÛÛÛÛÛ»    ÛÛÛÛÛÛÛ» ÛÛ» ÛÛ»      ÛÛÛÛÛÛÛ» ÛÛÛÛÛÛÛ»º',0
         db      'º ÛÛÛÛ»  ÛÛº ÛÛÉÍÍÍÛÛ»   ÛÛÉÍÍÍÍ¼ ÛÛº ÛÛº      ÛÛÉÍÍÍÍ¼ ÛÛÉÍÍÍÍ¼º',0
         db      'º ÛÛÉÛÛ» ÛÛº ÛÛº   ÛÛº   ÛÛÛÛÛ»   ÛÛº ÛÛº      ÛÛÛÛÛ»   ÛÛÛÛÛÛÛ»º',0
         db      'º ÛÛºÈÛÛ»ÛÛº ÛÛº   ÛÛº   ÛÛÉÍÍ¼   ÛÛº ÛÛº      ÛÛÉÍÍ¼   ÈÍÍÍÍÛÛºº',0
         db      'º ÛÛº ÈÛÛÛÛº ÈÛÛÛÛÛÛÉ¼   ÛÛº      ÛÛº ÛÛÛÛÛÛÛ» ÛÛÛÛÛÛÛ» ÛÛÛÛÛÛÛºº',0
         db      'º ÈÍ¼  ÈÍÍÍ¼  ÈÍÍÍÍÍ¼    ÈÍ¼      ÈÍ¼ ÈÍÍÍÍÍÍ¼ ÈÍÍÍÍÍÍ¼ ÈÍÍÍÍÍÍ¼º',0
         db      'ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼',0
cart1 proc
        mov     ax,4400h
        mov     bx,0
        mov     dx,pathemm
